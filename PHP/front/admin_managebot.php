            ...
            <div id="main-container">
                ...
                <div id="scroll-ai-container" class="mb_20">
                    <div class="button-horizontal-wrapper">
                        <button class="btn-bot selected">생활기록부</button>
                        <button class="btn-bot">문제 제작</button>
                        <button class="btn-bot">가정통신문</button>
                        <button class="btn-bot">활동지 작성</button>
                        <button class="btn-bot">업무 비서</button>
                        <button class="btn-bot">새로운 챗봇</button>
                        <button class="btn-bot">새로운 챗봇</button>
                        <button class="btn-bot">새로운 챗봇</button>
                        <button class="btn-bot">새로운 챗봇</button>
                        <button class="btn-bot">새로운 챗봇</button>
                ...
                <div class="flex-bw my_10">
                    <h2 class="fs_28 fw_600">생활기록부</h2>
                    <button class="btn-active activated">활성화</button>
                </div>
                ...
                <div id="ai-container">
                    <div class="mb_20">
                        ...
                        <label class="d-flex align-items-center gap_10 mb_12">
                            ...
                            <button class="btn-active">비활성화</button>
                        </label>
                    </div>
                    <div class="mb_20">
